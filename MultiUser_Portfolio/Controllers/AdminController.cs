...
namespace MultiUser_Portfolio.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> EditProfile()
        {
            ...
            return View(profile ?? new Profile { UserId = userId }); // If no profile exists, I'll create a new one.
        }
        ...
        {
            var userId = _userManager.GetUserId(User);
            var about = await _context.Abouts.FirstOrDefaultAsync(a => a.UserId == userId);
            return View(about ?? new About { UserId = userId });
        }
        ...
        public async Task<IActionResult> EditContact()
        {
            ...
            return View(contact ?? new Contact { UserId = userId });
        }
        ...
        {
            var userId = _userManager.GetUserId(User);
            return View(await _context.Experiences.Where(e => e.UserId == userId).OrderByDescending(e => e.StartDate).ToListAsync());
        }
        ...
        public async Task<IActionResult> EditExperience(int? id)
        {
            ...
            var userId = _userManager.GetUserId(User);
            var experience = await _context.Experiences.FirstOrDefaultAsync(e => e.Id == id && e.UserId == userId);
        ...
        public async Task<IActionResult> DeleteExperience(int? id)
        {
            if (id == null) return NotFound();
            var userId = _userManager.GetUserId(User);
            var experience = await _context.Experiences.FirstOrDefaultAsync(m => m.Id == id && m.UserId == userId);
            if (experience == null) return NotFound();
            return View(experience);
        }
        ...
        public async Task<IActionResult> DeleteProject(int? id)
        {
            if (id == null) return NotFound();
            var userId = _userManager.GetUserId(User);
            var project = await _context.Projects.FirstOrDefaultAsync(m => m.Id == id && m.UserId == userId);
            if (project == null) return NotFound();
            return View(project);
        }
        ...
        {
            var userId = _userManager.GetUserId(User);
            return View(await _context.Skills.Where(s => s.UserId == userId).ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteSkill(int? id)
        {
            if (id == null) return NotFound();
            var userId = _userManager.GetUserId(User);
            var skill = await _context.Skills.FirstOrDefaultAsync(m => m.Id == id && m.UserId == userId);
            if (skill == null) return NotFound();
            return View(skill);
        }
        ...
        {
            var userId = _userManager.GetUserId(User);
            return View(await _context.SocialLinks.Where(s => s.UserId == userId).ToListAsync());
        }
        ...
        public async Task<IActionResult> EditSocialLink(int? id)
        {
            if (id == null) return NotFound();
            var userId = _userManager.GetUserId(User);
            var socialLink = await _context.SocialLinks.FirstOrDefaultAsync(s => s.Id == id && s.UserId == userId);
        ...
        public async Task<IActionResult> DeleteSocialLink(int? id)
        {
            if (id == null) return NotFound();
            var userId = _userManager.GetUserId(User);
            var socialLink = await _context.SocialLinks.FirstOrDefaultAsync(m => m.Id == id && m.UserId == userId);
            if (socialLink == null) return NotFound();
            return View(socialLink);
        }
        ...
        {
            var userId = _userManager.GetUserId(User);
            return View(await _context.Educations.Where(e => e.UserId == userId).OrderByDescending(e => e.StartDate).ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteEducation(int? id)
        {
            if (id == null) return NotFound();
            var userId = _userManager.GetUserId(User);
            var education = await _context.Educations.FirstOrDefaultAsync(m => m.Id == id && m.UserId == userId);
            if (education == null) return NotFound();
            return View(education);
        }
        ...
        {
            var userId = _userManager.GetUserId(User);
            return View(await _context.Services.Where(s => s.UserId == userId).ToListAsync());
        }
        ...
        public async Task<IActionResult> EditService(int? id)
        {
            if (id == null) return NotFound();
            var userId = _userManager.GetUserId(User);
            var service = await _context.Services.FirstOrDefaultAsync(s => s.Id == id && s.UserId == userId);
        ...
        public async Task<IActionResult> DeleteService(int? id)
        {
            if (id == null) return NotFound();
            var userId = _userManager.GetUserId(User);
            var service = await _context.Services.FirstOrDefaultAsync(m => m.Id == id && m.UserId == userId);
            if (service == null) return NotFound();
            return View(service);
        }
